...
private:
    ...
    string _ConvertLoginRegisterObjectToLine(string Separator = "#//#")
    {

        string UserRecord = "";
        UserRecord += clsDate::GetSystemDateTimeString() + Separator;
        UserRecord += UserName + Separator;
        UserRecord += clsUtile::EncryptText(Password, 2) + Separator;
    ...
    static stLoginRegisterRecord _ConvertLoginRegisterLineToRecord(string Line, string Separator = "#//#")
    {
        ...
        LoginRegisterRecord.Password = clsUtile::DecryptText(LoginRegisterDataLine[2], 2);
    ...
    static  vector <stLoginRegisterRecord> _LoadRegistersDataFromFile()
    {
    ...
    static clsUser _ConvertLinetoUserObject(string Line, string Separator = "#//#")
    {
        ...
        return clsUser(enMode::UpdateMode, vUserData[0], vUserData[1], vUserData[2],
            vUserData[3], vUserData[4], clsUtile::DecryptText(vUserData[5], 2), stoi(vUserData[6]));
    ...
    static string _ConverUserObjectToLine(clsUser User, string Separator = "#//#")
    {
        ...
        UserRecord += clsUtile::EncryptText(User.Password, 2) + Separator;
...
public:
    ...
    enum enPermissions {
        ...
        pLoginRegister = 128, pCurrenciesExchange = 256
    ...
    void RegisterLogin()
    {
        ...
        string DataLine = _ConvertLoginRegisterObjectToLine();
    ...
    {
        return _LoadRegistersDataFromFile();
    }
